...
- (void)dealloc{
    ...
    [[fitpolo705CentralManager sharedInstance].peripheralManager.dataParser removeObserver:self
                                                                                forKeyPath:@"dataList"
                                                                                   context:nil];
}
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSKeyValueChangeKey,id> *)change context:(void *)context{
    if (self.isCancelled
        || object != [fitpolo705CentralManager sharedInstance].peripheralManager.dataParser
    ...
    fitpolo705ParseResultModel *model = list[0];
    if (self.timeout
        || !model
    ...
    NSString *numString = dic[fitpolo705CommunicationDataNum];
...
- (void)startCommunication{
    ...
    [[fitpolo705CentralManager sharedInstance].peripheralManager.dataParser addObserver:self
                                                                             forKeyPath:@"dataList"
